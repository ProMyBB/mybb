...
class installerOutput
{
	 ...
	 * @var string
	 */
	public $title = "MyBB Kurulum Sihirbazı";
...
END;
		...
		echo <<<END
			<div id="copyright">
			 Türkçe Çeviri: &copy; {$copyyear} <strong><a href="https://mybb.pro" target="_blank" rel="noopener" title="MyBB Türkçe Destek Forumu">MyBB.Pro</a></strong> - MyBB &copy; 2002-{$copyyear} MyBB Group
			</div>
		</div>
		</div>
		</div>
